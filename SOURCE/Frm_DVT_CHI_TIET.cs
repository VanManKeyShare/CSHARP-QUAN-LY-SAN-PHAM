...
namespace QUẢN_LÝ_SẢN_PHẨM
{
    public partial class Frm_DVT_CHI_TIET : Form
    {
        ...
        private void XEM_CSDL_THEO_ID(string ID_DATA)
        {
            ...
            vmk.MS_SQL_QUERY = "SELECT MA_DVT, TEN_DVT FROM DM_DON_VI_TINH WHERE (MA_DVT = @MA_DVT) ORDER BY MA_DVT ASC";
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            if (ten_dvt != "" && CFuns.CHECK_CHARACTER(ten_dvt, " ", true, true, true) == false)
            {
            ...
            VMK_DAO_FOR_MS_SQL vmk = new VMK_DAO_FOR_MS_SQL();
            vmk.MS_SQL_CONNECTION_STRING = SQL_CONNECTION_STRING;
            vmk.MS_SQL_QUERY = "INSERT INTO DM_DON_VI_TINH (MA_DVT, TEN_DVT) VALUES (@MA_DVT, @TEN_DVT)";
            vmk.MS_SQL_PARAMETERS = vmk.CREATE_MS_SQL_PARAMETERS();
            vmk.MS_SQL_PARAMETERS.Clear();
        ...
        private void btn_capnhat_Click(object sender, EventArgs e)
        {
            ...
            VMK_DAO_FOR_MS_SQL vmk = new VMK_DAO_FOR_MS_SQL();
            vmk.MS_SQL_CONNECTION_STRING = SQL_CONNECTION_STRING;
            vmk.MS_SQL_QUERY = "UPDATE DM_DON_VI_TINH SET TEN_DVT = @TEN_DVT WHERE MA_DVT = @MA_DVT";
            vmk.MS_SQL_PARAMETERS = vmk.CREATE_MS_SQL_PARAMETERS();
            vmk.MS_SQL_PARAMETERS.Clear();
            vmk.MS_SQL_PARAMETERS.Rows.Add("@MA_DVT", ma_dvt, SqlDbType.VarChar);
            vmk.MS_SQL_PARAMETERS.Rows.Add("@TEN_DVT", ten_dvt, SqlDbType.NVarChar);
